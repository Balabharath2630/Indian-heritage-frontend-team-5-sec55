  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const presignedResponse = await fetch(
        `http://localhost:8080/api/monuments/generate-presigned-url?fileName=${fileName}`
      );
      ...
      const dbResponse = await fetch("http://localhost:8080/api/monuments/save-metadata", {
        method: "POST",

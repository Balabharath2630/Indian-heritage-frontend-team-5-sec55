  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const presignedResponse = await fetch(
        `https://your-app-name.up.railway.app/api/monuments/generate-presigned-url?fileName=${fileName}`
      );
      ...
      const dbResponse = await fetch("https://your-app-name.up.railway.app/api/monuments/save-metadata", {
        method: "POST",
